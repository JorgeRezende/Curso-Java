...
@FXML  // dizendo que esse campo pertence ao Login.fxml
...
@FXML  // dizendo que esse campo pertence ao Login.fxml
	...
	public void entrar() {
		...
		if(emailValido && senhaValida) {
			...
			Notifications.create().position(Pos.TOP_RIGHT).title("Login FXML").text("Usuário ou Senha inválido! ").showError();
		}
	}
}
